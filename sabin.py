...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=100024643522326')
	back()
def linex():
	print("""\x1b[37m----------------------------------------------""")
def cls():
...
..####....####...######..######.
................................
 \x1b[38;5;196mv0.1\x1b[37m     """)
def info():
	print(f"""\x1b[37m----------------------------------------------
 AUTHOR     : Gole Babe
 GITHUB     : GoleBrand
 FACEBOOK   : Tamang Seller 
 VERSION    : \x1b[37m\x1b[38;5;196m{0.1}\x1b[37m
\x1b[37m----------------------------------------------""")
def banner():
	print(logo)
...
def menu(my_name,my_id):
	...
	linex()
	_____Goleeee_____ = input(' CHOOSE : ')
	if _____Goleeee_____ in ['1']:
		harry_public()
	elif _____Goleeee_____ in ['2']:
		fileopt()
	elif _____Goleeee_____ in ['3','03']:
		passask()
		harryresults()
	elif _____Goleeee_____ in ['4','04']:
		passask()
		...
		restart()
	elif _____Goleeee_____ in ['5','05']:
		contact()
	elif _____Goleeee_____ in ['0']:
		passask()
...
def harryresults():
    ok_file_path = '/sdcard/GOLEv0.1/GOLEv0.1-OK.txt'
    cp_file_path = '/sdcard/GOLEv0.1/GOLEv0.1-CP.txt'
    ...
    if user_choice == '1':
        ...
        linex()
        Fireee_file(ok_file_path, show_cookies)
    elif user_choice == '2':
        linex()
        Checking_file(cp_file_path, show_cookies=False)
    else:
        linex()
